...
<body>
    <div id="port-page">
        <center>
            <div class="navigation" onclick="creeperclose()"></div>
        </center>
        <iframe src="port-page.php" frameborder="0"></iframe>
    </div>
    <div id="body">
        ...
        <div class="card">
            ...
            <div class="row">
                <div class="col-auto">
                    <div id="pingResults"><ion-icon name='cellular'></ion-icon> <text id="ping">Connecting</text></div>
                </div>
                <div class="col">
                    <h1><ion-icon style="color:lightblue; position:relative; left:-20px;" onclick="alert('Ping ini adalah ping yang diberikan dari koneksi server')" name="alert-circle-outline"></ion-icon></h1>
                </div>
            </div>
            <hr>
            <h5><b>About</b></h5>
